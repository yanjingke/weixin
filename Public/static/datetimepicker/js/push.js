 ...
 function addItemstab1(number, lastIndex) {
		// alert(lastIndex+"  "+number);
// 生成新条目的HTML
	 var url= "/weixin/index.php/Home/Legislativtre/dynamic";
	  var b=lastIndex;
	  if(b!=a){
	    $.ajax({
			url:url,
...
//					/alert(content.ptime+" sada1");
 ...
 function addItemstab2(number, lastIndex) {
		// alert(lastIndex+"  "+number);
//生成新条目的HTML
	 var url= "/weixin/index.php/Home/Legislativtre/planList";
	  var b=lastIndex;
	  if(b!=c){
	    $.ajax({
			url:url,
 ...
 function addItemstab3(number, lastIndex) {
		// alert(lastIndex+"  "+number);
//生成新条目的HTML
	 var url= "/weixin/index.php/Home/Legislativtre/publicityList";
	  var b=lastIndex;
	  if(b!=d){
	    $.ajax({
			url:url,
 ...
 function addItemstab4(number, lastIndex) {
		// alert(lastIndex+"  "+number);
//生成新条目的HTML
	 var url= "/weixin/index.php/Home/Legislativtre/newlawList";
	  var b=lastIndex;
	  if(b!=e){
	    $.ajax({
			url:url,
 ...
 function initaddItemstabtabe1(data) {
  ...
  $(document).on("pageInit", "#page-fixed-tab-infinite-scroll", function(e, id, page) {
   ...
   // alert(e+"  ");
    ...
    var count=null;
     var url= "/weixin/index.php/Home/Legislativtre/count.html";
    $.ajax({
		url:url,
		type: "get",
