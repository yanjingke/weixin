    ...
    <div class="data-table">
        <table class="">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <a href="javascript:void(0);" onclick="restore('<?php echo ($vo["id"]); ?>')">还原</a>
                        <a href="javascript:void(0);" class="confirm " onclick="deletes('<?php echo ($vo["id"]); ?>')">删除</a>
                    </td>
