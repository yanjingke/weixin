    ...
    <script type="text/javascript">
        function check(){
            if(document.getElementById('tags').value == ""){
                $("#tags").siblings("span").text('*标签不能为空');
    ...
    <div class="tab-content">
        ...
        <form id="form" action="<?php echo U('save');?>" name="frm" method="post" onsubmit="return check()" onreset="cancle()">
            ...
            <div class="form-item cf">
                <label class="item-label">分类1<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="text" class="text input-large" name="tags[]" value="" id="tags"><span style="color:red;"></span>
                </div>
            </div>
            <div class="form-item cf">
                <label class="item-label">分类2<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="text" class="text input-large" name="tags[]" value="" id=""><span style="color:red;"></span>
                </div>
            </div>
            <div class="form-item cf">
                <label class="item-label">分类3<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="text" class="text input-large" name="tags[]" value="" id=""><span style="color:red;"></span>
                </div>
            </div>
