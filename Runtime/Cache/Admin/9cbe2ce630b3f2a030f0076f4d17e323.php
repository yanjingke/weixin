...
<head>
    ...
    <link href="/wechatservice/weixin/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/wechatservice/weixin/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/wechatservice/weixin/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/wechatservice/weixin/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/wechatservice/weixin/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/wechatservice/weixin/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/wechatservice/weixin/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/wechatservice/weixin/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/wechatservice/weixin/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<body>
    ...
    <div class="header">
        <!-- Logo -->
        <span class="logo">
             <img src="/wechatservice/weixin/Public/Admin/images/logo.jpg"/>
        </span>
        <!-- /Logo -->
...
<script>
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/wechatservice/weixin", //当前网站地址
            "APP"    : "/wechatservice/weixin/index.php", //当前项目地址
            "PUBLIC" : "/wechatservice/weixin/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/wechatservice/weixin/Public/static/think.js"></script>
    <script type="text/javascript" src="/wechatservice/weixin/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/wechatservice/weixin/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/wechatservice/weixin/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/wechatservice/weixin/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/wechatservice/weixin/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/wechatservice/weixin/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
$(function(){
	//搜索功能
