...
<body>
    ...
    <div class="main-title">
        <h2>
            所有菜单(<font style="font-weight: bolder;">备注：可设置3个一级菜单，每个一级菜单下可设置5个子菜单</font>)
        </h2>
    </div>
    ...
    <div class="cf">
        <div class="fl">
            <a class="btn " href="<?php echo U('addMenu');?>">快速添加</a>
            <!--<a class="btn " href="javascript:void(0);" onclick="checkall()">批量删除</a>-->
        </div>

        <!-- 高级搜索 -->
        <div class="fr">
            <a class="btn " href="<?php echo U('Home/Index/custom');?>" onclick="<?php echo U('Home/Index/custom');?>">启用配置</a>
        </div>
    </div>
    <script>
        function delmenu(id){
            var url = "<?php echo U('delmenu');?>";
    ...
    <div class="data-table">
        <table class="">
            ...
            <tr>
                ...
                <th class="" width="20%">菜单名称</th>
                <th class="" width="20%">菜单链接</th>
                <th class="" width="20%">菜单排序</th>
                <th class="" width="20%">菜单分组</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="<?php echo U('WeChat/editMenu?id='.$vo['id']);?>"><?php echo ($vo["name"]); ?></a></td>
                    <td><?php echo ($vo["url"]); ?></td>
                    <td><?php echo ($vo["group"]); ?></td>
                    <td><?php echo ($vo["g_name"]); ?></td>
                    <td><span><?=date('Y-m-d',$vo['addtime'])?></span></td>
                    <td>
                        <a href="<?php echo U('WeChat/editMenu?id='.$vo['id']);?>" >编辑</a>
                        <a href="javascript:void(0);" class="confirm " onclick="delmenu('<?php echo ($vo["id"]); ?>')">删除</a>
                    </td>
