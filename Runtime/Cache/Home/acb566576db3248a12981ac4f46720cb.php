...
$(function(){
	...
	$.post("/wxkeyset/ajaxReq",{"reqType":"getKeyset"},function(r){
		if(!r || !r["a_key"] || !r["a_key"][index] || !r["a_key"][index]["infotype"] || r["a_key"][index]["infotype"].length == 0){
			$("#all").addClass("active");
			return;
		}
		var infotype = r["a_key"][index]["infotype"];
